 ...
 */
intrinsic void enable_interrupts(void) { __asm volatile("cpsie i"); }

/**
 * @brief      Disables the interrupts.
 */
intrinsic void disable_interrupts(void) { __asm volatile("cpsid i"); }
 ...
 */
intrinsic void breakpoint(void) { __asm volatile("bkpt"); }
 ...
 *             it complete.
 */
intrinsic void data_sync_barrier(void) { __asm volatile("dsb"); }
 ...
 */
intrinsic void instruction_sync_barrier(void) { __asm volatile("isb"); }
